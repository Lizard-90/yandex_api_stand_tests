...
def negative_assert_symbol(first_name):
    ...
    # Проверяется, что в ответе есть code 400
    assert response.json()["code"] == 400
    # Проверяется, что в ответе есть нужный ответ
...
# Параметр fisrtName состоит из 16 символа
...
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("Человек_и_КО")
...
# Функция для негативной проверки где не передан параметр
